...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@london.com', 'password': 'test123'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@london.com', 'password': 'ws'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token no created if invalid  credentials are given"""
        create_user(email="test@lonodon.com", password="test123")
        payload = {'email': 'test@london.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'new name', 'password': 'new123'}
